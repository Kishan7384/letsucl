...
$res = mysqli_query($conn, "SELECT * FROM `customers` WHERE status='pending'  ORDER BY id DESC ");
                        ...
                        <div class="table-responsive">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 120px;" class="text-center">Statu</th>
                                        ...
                                        while($data = mysqli_fetch_array($res)){
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a href="editapplication.php?id=<?php echo base64_encode($data['id']) ?>" class="btn btn-success btn-sm ml-2"><i class="fa fa-edit"></i></a>
