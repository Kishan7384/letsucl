    ...
    <div class="content-header">
      ...
      <div class="col-lg-6 align-self-center ">
        ...
        <div class="col-lg-6 align-self-center text-right">
            <a href="index.php" class="btn btn-success box-shadow btn-icon btn-rounded"><i class="fa fa-plus"></i> Create New</a>
        </div>
    </div>
                                    ...
                                    if(mysqli_num_rows($res)>0){
                                        ...
                                        while($data = mysqli_fetch_array($res)){
                                            ...
                                            <td class="text-center"><?php echo $slno ?></td>
                                                ...
                                                <td class="text-center"> <a href="#<?php echo base64_encode($data['id']) ?>" button class="btn btn-warning"><?php echo $data['status'] ?></button></a>
                                                </td>
                                                <td class="text-center"><?php echo $data['date'] ?></td>
                                                <td class="text-center">


                                                          <a href="#<?php echo base64_encode($data['id']) ?>" class="btn btn-secondary btn-sm ml-2"><i class="fa fa-edit"></i></a>
                                                    <a href="data/editfinger2.php?id=<?php echo base64_encode($data['id']) ?>" class="btn btn-sm btn-dark">
                                    <img src="admin/assets/img/icon.png" height="20px" alt="H">
                                                        </a>
                                                         <a href="data/editfinger3.php?id=<?php echo base64_encode($data['id']) ?>" class="btn btn-sm btn-danger">
                                    <img src="admin/assets/img/icon.png" height="20px" alt="H">
                                                        </a>
                                                    <a href="data/editfinger.php?id=<?php echo base64_encode($data['id']) ?>" class="btn btn-sm btn-light">
                                    <img src="admin/assets/img/icon.png" height="20px" alt="H">
                                                        </a>
                                                    <a href="data/viewcust.php?id=<?php echo base64_encode($data['id']) ?>" class="btn btn-success btn-sm ml-2"><i class="fa fa-eye"></i></a>
